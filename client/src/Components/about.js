    ...
    <Container fluid>
      ...
      <Row>
        ...
        <h3>From the East: Vista, San Marcos, and Escondido</h3>
          <p>Take State Route 78 West and get off on El Camino Real and make a left. Make a right onto Carlsbad Village Drive and follow it until you see the train tracks. Grubby's is just past the train tracks and is on the left hand side. Due to frequent congestion at the interchange between State Route 78 and I-5 South, this is a more advisable route.</p>
        </Col>
      </Row>
      <Row>
        <Col>
